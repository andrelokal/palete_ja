...
public class OfertasCompradorAdapter extends ArrayAdapter<OfertasCompradorModel> {
    public OfertasCompradorAdapter(@NonNull Context context, int textViewResourceId, @NonNull List<OfertasCompradorModel> list) {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        OfertasCompradorModel item = getItem(position);

        if (convertView == null) {
            LayoutInflater inflater = (LayoutInflater) getContext().getSystemService(Context.LAYOUT_INFLATER_SERVICE);
            convertView = inflater.inflate(R.layout.list_oferta_comprador, null);
